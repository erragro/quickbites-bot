// @ts-nocheck — Animate UI's shipped icon typing is inconsistent with the
// `render` prop it internally passes to its own AnimateIcon component under
// Motion 13. Rather than fork the file, we skip TS checking here — the
// generated JS is fine, this is purely a type-only false-positive.
'use client';
